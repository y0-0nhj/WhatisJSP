...
<meta charset="UTF-8">
<title>게시판 목록</title>
<link href="../board_qna/css/list.css" rel="stylesheet" type="text/css">
...
<br>
	...
	<table class="table1">
		<tr>
			...
			<td align="right"><button onclick="location='../board_qna/writeFormBoardQna.jsp'">글쓰기</button></td>
		</tr>
	</table>
		...
		<table>
			...
			<tr class="<%=color%>">
				...
				if(level > 0) { // 댓글일 때 단계별로 왼쪽 마진 적용
					...
					// 댓글일 때 단계별로 댓글이미지 적용
					if(level%3 == 1) out.print("<img src='../board_qna/images/re01.png'>");
					else if(level%3 == 2) out.print("<img src='../board_qna/images/re02.png'>");
					else if(level%3 == 0) out.print("<img src='../board_qna/images/re03.png'>");
				}
				%>			
				
				<a href="../board_qna/contentBoardQna.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>">
				<%=article.getSubject() %></a>
				<% if(article.getReadcount() >= 20) {%>
					<img src="../board_qna/images/icon01.gif" height="12">
				<%}%>
				</td>
	...
	if(count > 0) {
		...
		if(startPage > 10) {
			out.print("<a href='../board_qna/listBoardQna.jsp?pageNum=" + (startPage-10) 
		...
		for(int i=startPage; i<=endPage; i++) {
			if (i == currentPage) { // 해당 페이지 선택 상태
				...
				out.print("<a href='../board_qna/listBoardQna.jsp?pageNum=" + i 
